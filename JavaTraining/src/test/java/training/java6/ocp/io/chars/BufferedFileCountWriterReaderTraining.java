...
import training.java6.ocp.io.chars.decorator.stream.BufferedFileWriterReaderDecorator;
...
public class BufferedFileCountWriterReaderTraining {

	protected static AbstractThreadManagerDecorator<Writer, Reader> threadManagerD = new CountThreadDecorator();

	protected static AbstractThreadComunicationDecorator<Writer, Reader> threadComunicationD = new BufferedFileWriterReaderDecorator(
			threadManagerD);
