...
import training.java6.ocp.io.chars.decorator.stream.StringWriterReaderDecorator;
...
public class StringCountWriterReaderTraining {

	protected static AbstractThreadManagerDecorator<Writer, Reader> threadManagerD = new CountThreadDecorator();

	protected static AbstractThreadComunicationDecorator<Writer, Reader> threadComunicationD = new StringWriterReaderDecorator(
			threadManagerD);
