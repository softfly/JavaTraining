...
import training.java6.ocp.io.bin.decorator.stream.StringBufferStreamDecorator;
...
public class StringBufferCountTraining {

	protected static AbstractThreadManagerDecorator<OutputStream, InputStream> threadManagerD = new CountThreadDecorator();

	protected static AbstractThreadComunicationDecorator<OutputStream, InputStream> threadComunicationD = new StringBufferStreamDecorator(
			threadManagerD);
